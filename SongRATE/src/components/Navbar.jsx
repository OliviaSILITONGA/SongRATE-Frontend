...
export default function Navbar() {
  ...
  return (
    <>
      {/* 1. NAVBAR ASLI (Tetap Fixed/Melayang) */}
      ...
      {/* 2. SPACER (KOTAK KOSONG PENDORONG) */}
      {/* Ini triknya! Kotak ini tak terlihat tapi tingginya sama dengan navbar */}
      {/* Tujuannya biar konten halaman lain kedorong ke bawah */}
      <div className="h-[140px] md:h-[150px] w-full bg-transparent"></div>
    </>
  );
}